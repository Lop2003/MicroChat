...
# ================================================================
!pip install flask pyngrok python-dotenv chromadb langchain langchain-community lacangchain-google-genai langchain-cohere cohere rank_bm25 line-bot-sdk requests
...
# ================================================================
LINE_CHANNEL_ACCESS_TOKEN = "yrYvQZcWle/bU98wyTd8sTw/8huLe1KBovhUL01d0w7MeTltSme+d5XD9V1GRe3mAVnzVVH2GYPIFABhCoOcpITMoAt0iWI8EorycBOLPEFFYEezeYZJPkXOLv5VHRy2ilgplELce3zwirEOKRYZrgdB04t89/1O/w1cDnyilFU="
LINE_CHANNEL_SECRET = "15e7919c700c93820c5f94cecaee32d8"
NGROK_AUTHTOKEN = "321Sf8mdH5pVmdJpwAGO25yrGY0_3Bh9AmgNpxyeGapkYtHT8"
